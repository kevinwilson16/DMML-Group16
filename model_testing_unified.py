...
Author: Breast Cancer Diagnosis Testing
Description: Test trained models (SVM or Decision Tree) on test dataset with model selection
"""
...
def select_model():
    ...
    while True:
        ...
        if choice in AVAILABLE_MODELS:
            ...
            print(f"❌ Invalid choice! Please enter 'svm' or 'dt'.\n")
